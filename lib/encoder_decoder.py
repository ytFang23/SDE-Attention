...
class Encoder_z0_SDE_RNN(nn.Module):
    ...
    # For every y_i we have two versions: encoded from data and derived from SDE by running it backwards from t_i+1 to t_i
    ...
    def __init__(self, latent_dim, input_dim, z0_diffeq_solver=None,
        ...
        # Latent Attention mechanisms (on hidden states between SDE and RNN)
    ...
    def run_sdernn(self, data, time_steps,
        ...
        for i in time_points_iter:
            ...
            # === Apply Latent Attention on SDE output before RNN ===
